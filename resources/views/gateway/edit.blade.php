...
@section('content')
    <div class="row m-b-20">
        <div class="col-lg-6 col-sm-6">
            <h6 class="page-title">Update Payment Gateway</h6>
        </div>
                                ...
                                <div class="row m-t-40">
                                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="gatewayname" name="gateway_name" class="form-control" placeholder="Method Name" value="{{ $gateway->name }}">
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4">
                                        <div class="form-group">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="minamount" name="min_amount" value="{{ round($gateway->min_amount, 2) }}" placeholder="0">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-addon">$</div>
                                            <input type="text" class="form-control" id="maxamount" name="max_amount" value="{{ round($gateway->max_amount, 2) }}" placeholder="0">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="addedField">
                                        @if($gateway->input_form != null)
                                            @foreach(json_decode($gateway->input_form, true) as $k => $v)
                                                {{-- {{ dd($v['field_name']) }} --}}
                                                <div class="row user-data">
                                                    <div class="col-lg-5">
                                                        <div class="form-group">
                                                            <input name="field_name[]" class="form-control" type="text" required value="{{$v['field_level']}}" placeholder="Field Name">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-3">
                                                        <div class="form-group">
                                                            <select name="type[]" class="form-control">
                                                                ...
                                                                <option value="file" @if($v['type'] == 'file') selected @endif> File </option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-3 ">
                                                    ...
                                                    <div class="col-lg-1">
                                                        <button class="btn btn-danger waves-effect waves-light removeBtn" type="button">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card card-outline-info">
                                ...
                                <div class="card-body">
                                    <textarea id="mymce" name="instruction">{{ $gateway->description }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
...
@section('custom-js')
    ...
    <script>
        $(".bt-switch input[type='checkbox'], .bt-switch input[type='radio']").bootstrapSwitch('state', {{ $gateway->crypto }} == 1 ? true : false);

        $(".bt-switch").on('switch-change', function(e) {
            console.log(e);
        });
