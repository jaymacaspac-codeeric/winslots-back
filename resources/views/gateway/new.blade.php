                                ...
                                <div class="row m-t-40">
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="gatewaycode" name="gateway_code" class="form-control" placeholder="Method Code">
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4">
                                        <div class="form-group">
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control method_rate" id="methodrate" name="method_rate" placeholder="0" value="{{ $settings->conversion_rate }}" readonly>
