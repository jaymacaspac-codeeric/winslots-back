                ...
                <div class="card-body">
                    <form class="form-horizontal create-agent-form" role="form">
                        ...
                        <div class="form-group row">
                            <label for="inputHorizontalSuccess" class="col-sm-2 col-form-label">Parent ID</label>
                            <div class="col-sm-10">
                                <input type="text" name="parent_id" class="form-control parent-id" id="" disabled>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="inputHorizontalSuccess" class="col-sm-2 col-form-label">Agent ID</label>
                            <div class="col-sm-10">
                                <div class="input-group">
                                    <input type="text" name="agent_username" class="form-control agent-id" id="" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="password" name="agent_pw" class="form-control" id="inputHorizontalDnger" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="inputHorizontalDnger" class="col-sm-2 col-form-label">Rate</label>
                            <div class="col-sm-4 input-group">
                                <input type="text" name="rate" class="form-control" id="inputHorizontalDnger" required>
                                <span class="input-group-addon">%</span>
                            </div>
                            <label for="inputHorizontalDnger" class="col-sm-2 col-form-label">Commision</label>
                            <div class="col-sm-4 input-group">
                                <input type="text" name="commission" class="form-control" id="inputHorizontalDnger" required>
                                <span class="input-group-addon">%</span>
                            </div>
                        </div>
                        <div class="form-group row">
